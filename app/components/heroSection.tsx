...
export default function heroSection() {
    ...
    return (
        <section className ="">
        <section className=" relative min-h-[60svh] bg-[url(/3d.webp)] bg-cover bg-center  bg-blend-overlay bg-black/60  flex flex-col   ">
...
Watch without limits. Movies, series, and more.
</h1>
